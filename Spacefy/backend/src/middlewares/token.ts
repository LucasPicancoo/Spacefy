...
// Define a interface para o conteúdo esperado dentro do token
interface ITokenData {
  id: string;
  role: string; // Exemplo: "usuario" ou "locatario"
}

// Estende o tipo Request do Express para incluir o campo `auth` com os dados do token decodificado
