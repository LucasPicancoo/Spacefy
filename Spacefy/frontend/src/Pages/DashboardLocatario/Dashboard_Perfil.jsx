    ...
    <div className="p-8 flex flex-col gap-10 h-full w-full">
      <div className="flex flex-col md:flex-row gap-12 w-full">
        ...
        <div className="w-full md:w-96 flex-shrink-0 flex flex-col gap-6">
          <div className="bg-white rounded-xl shadow p-8 flex flex-col items-center">
            ...
            <div className="text-center">
              <div className="font-bold text-2xl">{user.name} {user.surname}</div>
        ...
        <div className="flex-1 bg-white rounded-xl shadow p-12 flex flex-col gap-12 min-w-[340px]">
          <div>
            <div className="font-bold text-2xl mb-5">Meus Locais</div>
      ...
      {showCommentsModal && (
        <CommentsModal isOpen={showCommentsModal} onClose={() => setShowCommentsModal(false)} reviews={[]} />
      )}
    </div>
  );
} 